...
/* KODE TAMBAHAN AGAR LIST OBAT BISA DI SCROLL */
.select2-results__options {
    max-height: 250px !important; /* Batas tinggi maksimal dropdown */
...
<main class="content">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between">
            ...
            <div>
                <a href="<?= BASE_URL; ?>laporan/export_excel.php?type=kartu_stok&id_obat=<?= $filter_obat_id; ?>&id_unit=<?= $filter_unit_id; ?>&tgl_awal=<?= $filter_tgl_awal; ?>&tgl_akhir=<?= $filter_tgl_akhir; ?>" 
                class="btn btn-success btn-sm">
                    <i class="fas fa-file-excel"></i> Excel
                </a>
                <a href="<?= BASE_URL; ?>laporan/export_pdf.php?type=kartu_stok&id_obat=<?= $filter_obat_id; ?>&id_unit=<?= $filter_unit_id; ?>&tgl_awal=<?= $filter_tgl_awal; ?>&tgl_akhir=<?= $filter_tgl_akhir; ?>" 
